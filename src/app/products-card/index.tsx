...
const Index = (props: any) => {
  ...
  const handleClick = (_id: any) => {
    router.push(
      `/product-details/${_id}#${decodeURIComponent(
  ...
  const handleVarient = (_id: number, variant: any) => {
